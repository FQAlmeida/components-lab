...
import CustomContainer from "../../util/container_dif/custom_container";
import CustomDetail from "../../util/container_dif/custom_detail";
...
class DiferenciaisV1 extends React.Component {
  render() {
    return (
      <>
        <CustomContainer
        ...
        >
          ...
          <CustomDetail title="Metodologias Modernas" icon={<TiThList />}>
          <p>
              O nosso processo de desenvolvimento de processos segue os mais
              modernos modelos desenvolvidos, como por exemplo, o{" "}
              <strong>SCRUM</strong>, à qual seguimos como filosofia.
          ...
          <CustomDetail title="Coragem de Inovar" icon={<FaPaperPlane />}>
          <p>
              Nós não temos medo de fazer o novo, de fazer o que ningém mais
              faz, por isso o seu problema é a nossa paixão.
            </p>
